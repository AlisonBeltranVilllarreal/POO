...
public class CuentaBancaria {
    ...
    public CuentaBancaria(String tipoDeCuenta, long numeroCuenta, double saldo, Date fechaAlta, Cliente cliente, CuentaNomina cuentaNomina) {
    ...
    public CuentaBancaria(String tipoDeCuenta, long numeroCuenta, double saldo, Date fechaAlta, Cliente cliente, CuentaInversion cuentaInversion) {
        this.tipoDeCuenta = tipoDeCuenta;
        this.numeroCuenta = numeroCuenta;
        this.saldo = saldo;
        this.fechaAlta = fechaAlta;
