...
public class Cliente extends Persona {
    ...
    public void imprimirDatosClientes(){
        ...
        File iDP=new
                File("C:\\Users\\catss\\OneDrive\\Escritorio/Clientes.txt");
        try{
            FileWriter fw=new FileWriter(iDP,true);
            PrintWriter pw=new PrintWriter(fw);
            {
                pw.println("\nCliente: "+"\nNombre: "+"\nApellido Paterno: "+apePaterno+"\nApellido Materno: "+apeMaterno+
                        "\nFecha de Nacimiento: "+fechaNacimiento.dia+"/"+fechaNacimiento.mes+"/"+fechaNacimiento.anio+"\nRFC: "+rfc
                        +"\nDomicilio: "+domicilio+
                        "\nProductos: "+productos.getId()+productos.getDescripcion()+productos.getPrecio()+
                        "\nVendedores: "+"\nNombre: "+vendedor.nombre+
                        "\nApellido Paterno: "+vendedor.apePaterno+"\nApellido Materno: "+vendedor.apeMaterno+
                        "\nArea: "+vendedor.area);
            }
            fw.close();
