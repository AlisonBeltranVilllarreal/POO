...
public class Main {
    ...
    static File productosArchivo = new File("D:\\Productos.txt");
    static File vendedoresArchivo = new File("D:\\vendedores.txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((st = br2.readLine()) != null) {
            ...
            vendedores.add(new Vendedor(Integer.parseInt(vendedoresArray[0]),vendedoresArray[1],vendedoresArray[2],vendedoresArray[3], vendedoresArray[4], vendedoresArray[5], Float.parseFloat(vendedoresArray[6]), Integer.parseInt(vendedoresArray[7])));
        }
    ...
    public static void crearCliente() {
        ...
        String fechaFormat = sfd.format(new Date(anio-1900,mes-1,dia));
        String fechaNacimiento = fechaFormat;
    ...
    public static void crearVendedor() {
        ...
        try {
            String data = id+","+nombre+","+apellidoPaterno+","+apellidoMaterno+","+ fechaNacimiento +","+area+","+porcentajeComision+","+sueldoBase;
    ...
    public static void crearProducto() {
        ...
        try {
            String data = id +","+ descripcion +","+precio;
    ...
    public static void resultadosVendedor() {
        int id;
        ...
        for (Factura f : facturas) {
            if (f.getVendedor().getId() == vendedor.getId()) {
                ventasTotales += f.getTotal();
                f.imprimirDatos();
            }
        }
        System.out.println();

        float totalComisiones = ventasTotales * ((vendedor.getPorcentajeComision()/100));
        float sueldo = vendedor.getSueldoBase() + totalComisiones;
        System.out.println("Sueldo: " + sueldo);
        System.out.println("Total Comisiones: "+ totalComisiones);
        System.out.println("Sueldo neto: "+ vendedor.getSueldoBase());
        System.out.println();
    }
